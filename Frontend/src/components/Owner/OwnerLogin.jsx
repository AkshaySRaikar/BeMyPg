...
function Login() {
    ...
    return (
        <div className="flex h-screen">
            {/* Left Section */}
            <div className="w-1/2 bg-gradient-to-l from-black to-gray-500 flex flex-col justify-center items-center p-8">
                <div className="w-3/4 bg-black flex flex-col justify-center items-center p-8 rounded-lg shadow-lg">
                    <h2 className="text-2xl font-bold text-center text-white">Login</h2>
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 w-full">
                        ...
                        <button
                            type="submit"
                            className="w-full px-4 py-2 font-medium text-white bg-blue-600 rounded-full hover:bg-blue-700"
